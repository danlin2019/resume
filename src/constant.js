...
export const PROJECT_LIST = [
  {
    ...
    tagTitle:'使用技術',
    tag:['React','Vite','Tailwind CSS','Firebase','React Toolkit','Axios'],
    content:"獨立完成這項 Side Project，從功能規劃、資料庫設計到前端設計與配色的完整開發流程。使用 React + Vite 構建前後台，自行研究 Firebase，開發所需 API 並處理後端數據 ...",
    bg: "rgba(3,169,244, 0.94)",
